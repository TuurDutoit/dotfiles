...
defaults write com.apple.dock persistent-apps -array \
  ...
  "<dict><key>tile-data</key><dict><key>file-data</key><dict><key>_CFURLString</key><string>file:///Applications/OpenChamber.app</string><key>_CFURLStringType</key><integer>15</integer></dict></dict></dict>" \
