...
Source: `bt topics config topic-map --help` from bt 0.15.1.
Refresh: `python3 scripts/generate_reference.py`
-->

View or edit per-topic-map settings

Usage: bt topics config topic-map [OPTIONS] [TOPIC_MAP] [COMMAND]

Commands:
  show  Show a configured Topics topic map by name or function ID
  set   Update a configured Topics topic map by name or function ID
  help  Print this message or the help of the given subcommand(s)

Arguments:
  [TOPIC_MAP]  Topic map name or function ID to show

Options:
      --automation-id <AUTOMATION_ID>  Specific automation ID to search within
      --json                           Output as JSON
