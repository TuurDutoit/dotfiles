...
Source: `bt experiments delete --help` from bt 0.15.1.
Refresh: `python3 scripts/generate_reference.py`
-->

Delete an experiment

Usage: bt experiments delete [OPTIONS] [NAME]

Arguments:
  [NAME]  Experiment name (positional)

Options:
      --json                 Output as JSON
  -n, --name <NAME_FLAG>     Experiment name (flag)
