...
Source: `bt topics status --help` from bt 0.15.1.
Refresh: `python3 scripts/generate_reference.py`
-->

Show Topics automation status for the active project

Usage: bt topics status [OPTIONS]

Options:
      --full                      Show expanded diagnostics and progress counts
      --json                      Output as JSON
      --progress-window <WINDOW>  Window for status progress counts, for example 1h or 7d [env: BT_TOPICS_STATUS_PROGRESS_WINDOW=]
