...
Source: `bt functions view --help` from bt 0.15.1.
Refresh: `python3 scripts/generate_reference.py`
-->

View function details

Usage: bt functions view [OPTIONS] [SLUG]
