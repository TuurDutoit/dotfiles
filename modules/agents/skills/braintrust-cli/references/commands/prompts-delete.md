...
Source: `bt prompts delete --help` from bt 0.15.1.
Refresh: `python3 scripts/generate_reference.py`
-->

Delete a prompt

Usage: bt prompts delete [OPTIONS] [SLUG]

Arguments:
  [SLUG]  Prompt slug (positional) of the prompt to delete

Options:
      --json                 Output as JSON
  -s, --slug <SLUG_FLAG>     Prompt slug (flag) of the prompt to delete
  -f, --force                Skip confirmation prompt (requires slug)
