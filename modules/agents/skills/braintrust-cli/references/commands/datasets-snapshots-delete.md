...
Source: `bt datasets snapshots delete --help` from bt 0.15.1.
Refresh: `python3 scripts/generate_reference.py`
-->

Delete a saved dataset snapshot

Usage: bt datasets snapshots delete [OPTIONS] [DATASET] [SNAPSHOT]

Arguments:
  [DATASET]   Dataset name (positional)
  [SNAPSHOT]  Saved snapshot name to delete (positional)

Options:
      --json                 Output as JSON
  -n, --name <NAME>          Saved snapshot name to delete [env: BT_DATASETS_SNAPSHOT_DELETE_NAME=]
      --snapshot <XACT_ID>   Transaction id to delete [env: BT_DATASETS_SNAPSHOT_DELETE_XACT_ID=] [aliases: --version]
  -v, --verbose              Increase output verbosity [env: BRAINTRUST_VERBOSE=]
  -f, --force                Skip confirmation [env: BT_DATASETS_SNAPSHOT_DELETE_FORCE=]
