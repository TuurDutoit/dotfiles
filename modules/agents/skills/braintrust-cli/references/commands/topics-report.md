...
Source: `bt topics report --help` from bt 0.15.1.
Refresh: `python3 scripts/generate_reference.py`
-->

Download a saved topic map report JSON file

Usage: bt topics report [OPTIONS] [FUNCTION_ID]

Arguments:
  [FUNCTION_ID]  Topic map function ID

Options:
      --id <ID>              Topic map function ID [env: BT_TOPICS_REPORT_FUNCTION_ID=]
      --json                 Output as JSON
  -v, --verbose              Increase output verbosity [env: BRAINTRUST_VERBOSE=]
      --version <VERSION>    Specific topic map version/xact ID [env: BT_TOPICS_REPORT_VERSION=]
      --output <OUTPUT>      Output file path. Omit to write the report JSON to stdout [env: BT_TOPICS_REPORT_OUTPUT=]
