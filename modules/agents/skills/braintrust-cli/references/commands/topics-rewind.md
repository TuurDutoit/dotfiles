...
Source: `bt topics rewind --help` from bt 0.15.1.
Refresh: `python3 scripts/generate_reference.py`
-->

Rewind recent Topics history and queue it to reprocess

Usage: bt topics rewind [OPTIONS] <TOPIC_WINDOW>

Arguments:
  <TOPIC_WINDOW>  Topic window to reprocess, for example 1h or 7d

Options:
      --automation-id <AUTOMATION_ID>  Specific automation ID to rewind
      --json                           Output as JSON
