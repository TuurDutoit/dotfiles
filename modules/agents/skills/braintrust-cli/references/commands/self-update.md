...
Source: `bt self update --help` from bt 0.15.1.
Refresh: `python3 scripts/generate_reference.py`
-->

Update bt in-place (installer-managed installs only)

Usage: bt self update [OPTIONS]

Options:
      --check                Check for updates without installing
      --json                 Output as JSON
      --channel <CHANNEL>    Update channel (defaults to the build channel) [possible values: stable, canary]
