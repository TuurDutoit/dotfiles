...
Source: `bt prompts view --help` from bt 0.15.1.
Refresh: `python3 scripts/generate_reference.py`
-->

View a prompt's content

Usage: bt prompts view [OPTIONS] [SLUG]

Arguments:
  [SLUG]  Prompt slug (positional)

Options:
      --json                 Output as JSON
  -s, --slug <SLUG_FLAG>     Prompt slug (flag)
  -v, --verbose              Increase output verbosity [env: BRAINTRUST_VERBOSE=]
      --web                  Open in browser instead of showing in terminal
