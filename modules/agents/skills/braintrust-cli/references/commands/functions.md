...
Source: `bt functions --help` from bt 0.15.1.
Refresh: `python3 scripts/generate_reference.py`
-->

Manage functions (tools, scorers, and more)

Usage: bt functions [OPTIONS] [COMMAND]

Commands:
  list    List functions in the current project
  view    View function details
  delete  Delete a function
  invoke  Invoke a function
  push    Push local function definitions
  pull    Pull remote function definitions
...
Options:
  ...
  -t, --type <FUNCTION_TYPE>  Filter by function type [possible values: llm, scorer, task, tool, custom-view, preprocessor, facet, classifier, tag, parameters]
  -h, --help                  Print help
