...
Source: `bt datasets --help` from bt 0.15.1.
Refresh: `python3 scripts/generate_reference.py`
-->

Manage datasets

Usage: bt datasets [OPTIONS] [COMMAND]

Commands:
  list       List all datasets
  create     Create a new dataset, optionally seeding rows from a file, --rows, or stdin
  update     Upsert remote dataset rows by record id [aliases: add, refresh]
  view       View a dataset
  delete     Delete a dataset
  snapshots  Manage dataset snapshots [aliases: versions, version]
  pipeline   Run full dataset pipelines, or stage pull/transform/push
